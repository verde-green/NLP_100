...
if __name__ == "__main__":
    assert isStopWord("a")
    assert isStopWord("do")
    assert isStopWord("What")
    assert isStopWord("We")

    assert not isStopWord("run")
    assert not isStopWord("going")
    assert not isStopWord("Python")
    assert not isStopWord("Java")
    assert not isStopWord(" ")
    assert not isStopWord("")
